...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [16] = {
    ...
    [sym_mode] = ACTIONS(107),
    [sym_literal] = ACTIONS(107),
    [aux_sym_keycode_token1] = ACTIONS(107),
    [anon_sym_return] = ACTIONS(107),
    [anon_sym_tab] = ACTIONS(107),
    [anon_sym_space] = ACTIONS(107),
    ...
    [anon_sym_pageup] = ACTIONS(107),
    [anon_sym_pagedown] = ACTIONS(107),
    ...
    [anon_sym_f1] = ACTIONS(107),
    [anon_sym_f2] = ACTIONS(107),
    [anon_sym_f3] = ACTIONS(107),
    [anon_sym_f4] = ACTIONS(107),
    [anon_sym_f5] = ACTIONS(107),
    [anon_sym_f6] = ACTIONS(107),
    [anon_sym_f7] = ACTIONS(107),
    [anon_sym_f8] = ACTIONS(107),
    [anon_sym_f9] = ACTIONS(107),
    [anon_sym_f10] = ACTIONS(107),
    [anon_sym_f11] = ACTIONS(107),
    [anon_sym_f12] = ACTIONS(107),
    [anon_sym_f13] = ACTIONS(107),
    [anon_sym_f14] = ACTIONS(107),
    [anon_sym_f15] = ACTIONS(107),
    [anon_sym_f16] = ACTIONS(107),
    [anon_sym_f17] = ACTIONS(107),
    [anon_sym_f18] = ACTIONS(107),
    [anon_sym_f19] = ACTIONS(107),
    [anon_sym_f20] = ACTIONS(107),
    [anon_sym_sound_up] = ACTIONS(107),
    [anon_sym_sound_down] = ACTIONS(107),
    [anon_sym_mute] = ACTIONS(107),
    [anon_sym_play] = ACTIONS(107),
    [anon_sym_previous] = ACTIONS(107),
    [anon_sym_next] = ACTIONS(107),
    [anon_sym_rewind] = ACTIONS(107),
    [anon_sym_fast] = ACTIONS(107),
    [anon_sym_brightness_up] = ACTIONS(107),
    [anon_sym_brightness_down] = ACTIONS(107),
    [anon_sym_illumination_up] = ACTIONS(107),
    [anon_sym_illumination_down] = ACTIONS(107),
  ...
  [17] = {
    ...
    [sym_modifier_keyword] = STATE(53),
    [sym_literal] = ACTIONS(13),
    [aux_sym_keycode_token1] = ACTIONS(109),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [30] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(64),
  ...
  [45] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(62),
  ...
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_blacklist, 4, 0, 3),
  [75] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_blacklist, 4, 0, 3),
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action, 4, 0, 0),
  [79] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_action, 4, 0, 0),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hotkey, 1, 0, 0),
  [83] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_hotkey, 1, 0, 0),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_blacklist, 3, 0, 0),
  [87] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_blacklist, 3, 0, 0),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mode_decl, 4, 0, 0),
  [91] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_mode_decl, 4, 0, 0),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_load, 2, 0, 1),
  [95] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_load, 2, 0, 1),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hotkey, 3, 0, 0),
  [99] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_hotkey, 3, 0, 0),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mode_decl, 5, 0, 0),
  [103] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_mode_decl, 5, 0, 0),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action, 5, 0, 0),
  [107] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_action, 5, 0, 0),
  [109] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [111] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action, 3, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_action, 3, 0, 0),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_proc_map_lst_repeat1, 2, 0, 0),
  [119] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_proc_map_lst_repeat1, 2, 0, 0), SHIFT_REPEAT(47),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_proc_map_lst, 1, 0, 0),
  [124] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_proc_map_lst, 2, 0, 0),
  ...
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_keycode, 1, 0, 0),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_keysym, 3, 0, 0),
  ...
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_proc_map, 2, 0, 0),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_modes, 1, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_proc_map, 3, 0, 0),
  [158] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [160] = {.entry = {.count = 1, .reusable = true}}, SHIFT(49),
  [162] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_command_repeat1, 2, 0, 0), SHIFT_REPEAT(55),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_command_repeat1, 2, 0, 0),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_modes_repeat1, 2, 0, 0),
  [169] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_modes_repeat1, 2, 0, 0), SHIFT_REPEAT(60),
  [172] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [174] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [176] = {.entry = {.count = 1, .reusable = true}}, SHIFT(63),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_modes, 2, 0, 0),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_blacklist_repeat1, 2, 0, 4),
  [182] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_blacklist_repeat1, 2, 0, 4), SHIFT_REPEAT(49),
  [185] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [187] = {.entry = {.count = 1, .reusable = true}}, SHIFT(28),
  [189] = {.entry = {.count = 1, .reusable = true}}, SHIFT(37),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_blacklist_repeat1, 1, 0, 2),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_modifier_keyword, 1, 0, 0),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mod, 3, 0, 0),
  [197] = {.entry = {.count = 1, .reusable = true}}, SHIFT(20),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mod, 1, 0, 0),
